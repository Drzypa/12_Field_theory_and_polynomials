...
\usepackage{pmmeta}
\pmcanonicalname{Imaginary}
\pmcreated{2013-03-22 12:21:11}
\pmmodified{2013-03-22 12:21:11}
...
\pmsynonym{pure complex}{Imaginary}
\pmrelated{Complex}
\pmrelated{ComplexNumber}
\pmrelated{ImaginaryUnit}
\pmrelated{ImaginaryQuadraticField}
\pmdefines{imaginary}
\pmdefines{imaginary number}
\pmdefines{imaginary element}
\pmdefines{purely imaginary number}
\pmdefines{purely imaginary}
\pmdefines{pure imaginary number}
\pmdefines{pure imaginary}
